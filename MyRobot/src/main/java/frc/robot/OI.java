...
public JoystickButton leftbumpwe;
...
leftbumpwe = new JoystickButton(joystick1, 5);
leftbumpwe.whileHeld(new downarm());
rightbumper = new JoystickButton(joystick1, 6);
rightbumper.whileHeld(new UPARM());
yButton = new JoystickButton(joystick1, 4);
yButton.whileHeld(new ClimberUp());
xButton = new JoystickButton(joystick1, 3);
xButton.whileHeld(new ClimberDown());
bButton = new JoystickButton(joystick1, 2);
bButton.whileHeld(new OuttakeBall());
aButton = new JoystickButton(joystick1, 1);
aButton.whileHeld(new IntakeBall());
