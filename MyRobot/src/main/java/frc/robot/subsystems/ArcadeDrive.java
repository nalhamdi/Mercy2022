...
rightMotorController = new PWMTalonSRX(0);
addChild("rightMotorController",rightMotorController);
rightMotorController.setInverted(false);
        
leftmotorcontroller = new PWMTalonSRX(1);
addChild("Left motor controller",leftmotorcontroller);
leftmotorcontroller.setInverted(false);
        
robotDrive21 = new RobotDrive(leftmotorcontroller, rightMotorController);
